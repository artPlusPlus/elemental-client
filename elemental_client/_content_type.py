...
class ContentType(Resource):
    ...
    base_content_types = RemoteValue('base_ids')

    @base_content_types.on_get
    def base_content_types(self, base_ids):
        return process_inbound_resource_list_data(self._client, base_ids)

    @base_content_types.on_set
    def base_content_types(self, base_types_data):
        return process_outbound_resource_list_data(base_types_data)

    attribute_types = RemoteValue('attribute_type_ids')
